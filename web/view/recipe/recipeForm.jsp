		...
		<form action="<%=request.getContextPath() %>/recipe/recipeFormEnd" method="post" enctype="multipart/form-data" onsubmit="return fn_submit_validate();">
			<div id="basic_info" class="info">
				...
				<div class="input_container">
					...
					<div class="input"><input type="text" name="recipe_video_address" id="video_address" placeholder="동영상이 있으면 주소를 입력하세요."/></div>
				</div>
				<div class="input_container">
				...
				<div class="input_container" id="ingredient_container">
					...
					<div id="bundle_container">
						...
						<div class="ingredient_bundle">
							<input type="text" name="ingredient_category"/>
							<ul class="ingredient_ul">
								<li class="ingredient_li"><input type="text" name="ingredient_name" value=""/><input type="text" name="ingredient_amount" value=""/><a>x</a></li>
								<li class="ingredient_li"><input type="text" name="ingredient_name" value=""/><input type="text" name="ingredient_amount" value=""/><a>x</a></li>
								<li class="ingredient_li"><input type="text" name="ingredient_name" value=""/><input type="text" name="ingredient_amount" value=""/><a>x</a></li>
